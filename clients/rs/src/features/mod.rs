...
pub fn get() -> Features {
  ...
  features.insert("error_invoke".to_string(), error_invoke::run_test_case);
  features.insert("error_subinvoke".to_string(), error_subinvoke::run_test_case);
  features.insert("error_resolve_uri".to_string(), error_resolve_uri::run_test_case);
